...
function icon_svg($name)
{
    $icons = [
        ...
        'heart' =>
            '<path d="M12 21s-7.5-4.7-10-9.3C.4 8.1 2 4.5 5.6 4c2-.3 3.8.7 6.4 3.2C14.6 4.7 16.4 3.7 18.4 4c3.6.5 5.2 4.1 3.6 7.7C19.5 16.3 12 21 12 21Z"/>',
    ];
...
<head>
    ...
    <title>
        ...
        Dive — Discover the Depths of Siquijor
    </title>
    ...
    <style>
        ...
        /* Logged-in navigation additions */
...
<section class="hero">
    ...
    <div class="hero-inner">
        ...
        <p>
            ...
            Dive for unforgettable underwater adventures.

            From vibrant coral gardens to majestic marine life,
            dive into crystal clear waters with our expert guides.
    ...
    <div class="container">
        ...
        <div class="section-head">
            ...
            <p>
                ...
                Whether you're a seasoned diver or looking for
                a relaxing boat tour, we offer tailored
                experiences to make your Siquijor trip
                extraordinary.
        ...
        <div class="journey-grid">
            ...
            <div class="journey-text">
                ...
                <p>
                    ...
                    Dive is an authorized training center.

                    We offer comprehensive courses from beginner
                    to professional levels, with small class
                    sizes for personalized instruction.
            ...
            <div class="journey-img">
                ...
                <img
                    src="images/scubawoman.jpg"
                    alt="Diver descending underwater"
                >
    ...
    <div class="container">
        ...
        <div class="section-head">
            ...
            <p>
                ...
                We are passionate about the ocean and committed
                to safety, conservation, and providing
        ...
        <div class="container footer-grid">
            ...
            <div class="footer-brand">
                ...
                <p>
                    ...
                    Dive is Siquijor's premier dive center.

                    We are dedicated to providing safe,
                    thrilling, and eco-friendly diving
                    experiences while preserving the natural
                ...
                <div class="socials">
                    ...
                    >
                        ...
                        >
                            ...
                            <path
                                d="M14 9h3V6h-3c-1.7 0-3 1.3-3 3v2H9v3h2v6h3v-6h3l1-3h-4V9c0-.5.5-1 1-1Z"
                            />
                ...
                <ul class="contact-list">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <path
                                d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .3 2 .7 2.9a2 2 0 0 1-.4 2.1L8 10a16 16 0 0 0 6 6l1.3-1.4a2 2 0 0 1 2.1-.4c.9.4 1.9.6 2.9.7a2 2 0 0 1 1.7 2Z"
                            />
